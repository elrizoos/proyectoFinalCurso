...
<body>
    ...
    @section('content')
            ...
            <div class="user-stats">
                ...
                <div class="stat">
                    ...
                    <p>
                        ...
                        if ($asistencias < 30) {
                            echo 'Básico';
                        } elseif ($asistencias >= 30 && $asistencias < 60) {
                            echo 'Intermedio';
                        } else {
                            echo 'Avanzado';
                        }
        ...
        <div class="modal fade" id="horasEntrenamientoModal" tabindex="-1" role="dialog"
            aria-labelledby="horasEntrenamientoModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
