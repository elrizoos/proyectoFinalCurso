       ...
       <div class="col col-10">
           ...
           <div class="row row-12">
               ...
               <div class="form-group">
                   ...
                   <input type="password" name="password" id="password" class="form-control" value="{{isset($alumno->password) ? $alumno->password : old('password')}}">
               </div>

               <div class="form-group">
                   <label for="password_confirmation">Confirmar contraseña:</label>
                   <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" value="{{isset($alumno->password) ? $alumno->password : old('password')}}">
               </div>
               <div class="form-group col col-4">
